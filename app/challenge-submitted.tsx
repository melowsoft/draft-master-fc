...
export default function ChallengeSubmittedScreen() {
    ...
    <ThemedView style={styles.container}>
      <View style={[styles.content, { paddingTop, paddingBottom }]}>
        ...
        <ThemedText type="body" style={[styles.subtitle, { color: theme.textSecondary }]}>
          {challengeTitle
            ? `You’ve already submitted an entry for “${challengeTitle}”.`
            : 'You’ve already submitted an entry for this challenge.'}
        </ThemedText>
